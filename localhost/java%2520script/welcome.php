        ...
        <div class="song_side">
           <nav>
            <ul>
               ...
               <a href="#" ><li id="mylib">My Library</li></a>
                <li>Radio</li>
            </ul>
            <div class="search">
           ...
           <div class="content">
            ...
            <p>You were shadow to my light did you feel us another start you fade<br> away afraid our aim is out of sight Wanna see us Alive</p>
            <div class="buttons">
           ...
           <div class="popular_song">
            ...
            <li class="songItem" > 
                    ...
                    <h5>On My Way<br>
                    <div class="subtitle">Alan Walker</div></h5>
...
<li class="songItem" > 
    ...
    <div class="subtitle">Alan Walker</div></h5>
            ...
            <div class="item">
                <li>
                    <a href="anirudh.php"><img src="anirudh.jpeg" alt="Anirudh Ravichander" title="Anirudh Ravichander"></a>
                </li>
                <li>
        ...
        <div class="master_play">
           ...
           <img src="img/15.jpg" alt="" id="poster_master_play">
           <h5 id="title">Lut Gaye
