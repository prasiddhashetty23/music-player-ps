...
<li class="songItem" > 
    ...
    <div class="subtitle">Alan Walker</div></h5>
            ...
            <div class="item">
                ...
                <li>
                    <a href="welcome.php"><img src="img/alan.jpg" alt="Alan Walker" title="Alan Walker"></a>
                </li>
                <li>
        ...
        <div class="master_play">
           ...
           <img src="imag/1.jpeg" alt="" id="poster_master_play">
           <h5 id="title">Andha Kanna Paathaakaa
            <div class="subtitle">Yuvar Shankar Raja</div>
           </h5>
           <div class="icon">
